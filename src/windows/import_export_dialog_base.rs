...
mod imp {
    ...
    impl AdwDialogImpl for ImportExportDialogBase {}
}
...
impl ImportExportDialogBase {
    ...
    fn check_activate_response(&self) {
        ...
        self.imp()
            .button_ok
            .set_sensitive(any_option_activated && password_set);
    }
    ...
    async fn on_ok(&self) {
        ...
        self.imp().button_ok.set_sensitive(false);
        self.imp().button_ok.set_visible(false);
...
pub trait ImportExportDialogBaseImpl: AdwDialogImpl + 'static {
    fn on_activities(
        &self,
...
unsafe impl<T: ImportExportDialogBaseImpl> IsSubclassable<T> for ImportExportDialogBase {
    fn class_init(class: &mut glib::Class<Self>) {
        <adw::Dialog as IsSubclassable<T>>::class_init(class.upcast_ref_mut());
    ...
    fn instance_init(instance: &mut glib::subclass::InitializingObject<T>) {
        <adw::Dialog as IsSubclassable<T>>::instance_init(instance);
    }
}
